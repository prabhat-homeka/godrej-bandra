      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2">
          {PLANS.map((plan) => (
            <div
              key={plan.type}
              className="overflow-hidden rounded-xl bg-white shadow-[0_0_14px_-8px_var(--color-gold)]"
            >
              <button
              ...
              <div className="p-5">
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-xl bg-gold py-2.5 text-sm font-semibold text-ink transition hover:bg-gold-dark"
                >
